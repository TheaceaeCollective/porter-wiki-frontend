...
const togNav = (newValue) => {
    // pass newValue to force toggle
    ...
    <div class="w-screen h-16 fixed bg-background-3 z-40 pt-2 pb-14">
        ...
        <Transition name="slidedown-fade">
            ...
            >
                ...
                >
                    <div
                        class="flex flex-col lg:flex-row items-center text-center gap-4"
                    >
                        <NavBarAccount />
                        <a
                            class="hover:text-accent text-lg font-light cursor-pointer"
                            v-for="link in leftLinkList"
                            @click="(e) => openLink(e, link.route)"
                            :href="link.route"
                            >{{ link.name }}</a
                        >
                    </div>
