...
let headerId =
    props.headerId || props.text.toLowerCase().replace(/[^\w]+/g, "-");
...
function copyLink() {
    ...
    navigator.clipboard
        .writeText(`${window.location.protocol}//${window.location.host}${url}`)
        .then(() =>
