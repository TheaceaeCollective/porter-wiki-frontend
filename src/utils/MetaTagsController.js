...
export default class MetaTagsController {
    ...
    static setMeta(url, data, fromAPI = false) {
        ...
        if (fromAPI) {
            ...
            let pageDesc = (descType) =>
                Utils.truncateMDText(data.content, this.maxMetaLengths[descType]) ||
                Utils.truncateMDText(data.meta.description, this.maxMetaLengths[descType]) ||
                this.defaultMeta.meta.description;
            let metaArr = [
